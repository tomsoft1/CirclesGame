...
class Player extends PositionComponent {
  ...
  static final _clear = Paint()
    ..color = Color.fromARGB(212, 146, 76, 76)
...
class Arrow extends PositionComponent with HasPaint {
  ...
  static final _paintInner = Paint()..color = Color.fromARGB(255, 255, 136, 0);
  double power = 0;
  @override
  void render(Canvas canvas) {
    super.render(canvas);
...
class Platform extends PositionComponent {
  ...
  static final _paintTarget = Paint()..color = Color.fromARGB(255, 255, 174, 0);
...
class CirclesGame extends FlameGame with TapDetector {
  ...
  OpacityEffect opacityEffect =
      OpacityEffect.to(0.0, EffectController(duration: 2), onComplete: () {
    print("Opacity completed");
  });
  ...
  @override
  Color backgroundColor() => Color.fromARGB(255, 230, 241, 233);
...
//    player.add(refArrow);
  ...
  void onTapUp(TapUpInfo info) {
    ...
    arrow.power = 0;
    if (opacityEffect.parent == null) {
      arrow.add(opacityEffect);
      opacityEffect.reset();
    } else {
      opacityEffect.reset();
    }
